    ...
    <section className="bg-primary py-16 px-4 sm:px-8 md:px-12 lg:px-16">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-600 mb-12">
          Admissions at Mathurata Maha Vidyalaya is as per the following procedure.
        </p>
        ...
        <div className="bg-gray-100 rounded-lg shadow-lg overflow-hidden">
          ...
          <div className="md:flex">
            ...
            <div className="md:w-1/2 bg-secondary text-white py-8 px-6">
              ...
              <p className="text-lg"> Congratulations! Your ward is in Mathurata Maha Vidyalaya!</p>
            </div>
          </div>
        </div>
      </div>
